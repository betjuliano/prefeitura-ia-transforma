...
const Header: React.FC = () => {
  return (
    <header className="bg-gov-blue text-white py-20 px-4 text-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-gov-blue/70 to-blue-500/30"></div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto animate-fade-in">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button className="btn-whatsapp text-base" size="lg" onClick={() => window.open('https://wa.me/55999631365', '_blank')}>
